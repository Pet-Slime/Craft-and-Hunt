...
public class ItemGolemKit extends Item {

	
	public ItemGolemKit(Properties properties) {
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
        ...
        } else if (offhandSlot.getItem().equals(RegisterOffhand.golem_kit.get())) {
    ...
    public void castSpell(World worldIn, PlayerEntity playerIn) {
		...
		IronSummonEntity golem = RegisterEntityType.IRONSUMMON.get().create(playerIn.world);
		golem.setOwner(playerIn);
		golem.setLimitedLife(960);
		golem.moveToBlockPosAndAngles(blockpos, 0.0F, 0.0F);
