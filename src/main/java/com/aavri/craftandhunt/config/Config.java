...
public class Config {
    ...
    public static DoubleValue bone_tool_efficiency;
    public static DoubleValue bone_tool_attackDamage;
    ...
    public static DoubleValue spider_tool_efficiency;
    public static DoubleValue spider_tool_attackDamage;
    ...
    public static DoubleValue shark_tool_efficiency;
    public static DoubleValue shark_tool_attackDamage;
    ...
    public static DoubleValue wither_tool_efficiency;
    public static DoubleValue wither_tool_attackDamage;
    ...
    public static DoubleValue blaze_tool_efficiency;
    public static DoubleValue blaze_tool_attackDamage;
    ...
    public static DoubleValue shell_tool_efficiency;
    public static DoubleValue shell_tool_attackDamage;
    ...
    public static ForgeConfigSpec.IntValue drop_chance_cave_spider;
    public static ForgeConfigSpec.IntValue drop_chance_squid;
    public static ForgeConfigSpec.IntValue drop_chance_fox;
    public static ForgeConfigSpec.IntValue drop_chance_lamprey;
    ...
    public static void init(ForgeConfigSpec.Builder Builder){
        ...
        blaze_helmDefense = Builder.comment("Magma Helm Defense Value (Default: 3).").defineInRange("blaze_helmDefense", 3, 1, 50);
        ...
        phantom_durabilityValue = Builder.comment("Phantom Durability Value (Default: 18).").defineInRange("phantom_durabilityValue", 18, 1, 50);
        ...
        guardian_durabilityValue = Builder.comment("Guardian Durability Value (Default: 20).").defineInRange("guardian_durabilityValue", 25, 1, 50);
        ...
        bear_durabilityValue = Builder.comment("Bear Durability Value (Default: 5).").defineInRange("bear_durabilityValue", 5, 1, 50);
        ...
        drop_chance_spider_chitin		 = Builder.comment("Drop chance for spider chitin  (Default: 34).").defineInRange(		"drop_chance_spider_chitin", 	34, 0, 100);
        drop_chance_wolf_hide			 = Builder.comment("Drop chance for wolf hide (Default: 34).").defineInRange(			"drop_chance_wolf_hide", 		34, 0, 100);
        drop_chance_fox_hide			 = Builder.comment("Drop chance for fox hide (Default: 34).").defineInRange(			"drop_chance_fox_hide", 		34, 0, 100);
        ...
        drop_chance_evoker				 = Builder.comment("Drop chance for Evoker's Book (Default: 1).").defineInRange(		"drop_chance_evoker", 			1, 0, 100);
        drop_chance_witch				 = Builder.comment("Drop chance for Witch's Book (Default: 1).").defineInRange(			"drop_chance_witch", 			1, 0, 100);
        drop_chance_cave_spider			 = Builder.comment("Drop chance for Poison Sack (Default: 1).").defineInRange(			"drop_chance_cave_spider", 		1, 0, 100);
		drop_chance_squid				 = Builder.comment("Drop chance for Gloomy Ink Sack (Default: 1).").defineInRange(		"drop_chance_squid", 			1, 0, 100);
		drop_chance_fox					 = Builder.comment("Drop chance for Mystical Fox Tail (Default: 1).").defineInRange(	"drop_chance_fox", 				1, 0, 100);
		drop_chance_mooshroom			 = Builder.comment("Drop chance for Puff Shroom (Default: 1).").defineInRange(			"drop_chance_mooshroom", 		1, 0, 100);
		drop_chance_creeper				 = Builder.comment("Drop chance for Seed Cluster (Default: 1).").defineInRange(			"drop_chance_creeper", 			1, 0, 100);
		drop_chance_totems			 	 = Builder.comment("Drop chance for Totems to drop (Default: 1).").defineInRange(		"drop_chance_totems", 			1, 0, 100);
		drop_chance_lamprey				 = Builder.comment("Drop chance for Vampire's Fang (Default: 1).").defineInRange(		"drop_chance_lamprey", 			1, 0, 100);
		drop_chance_bee_chitin		 	 = Builder.comment("Drop chance for bee chitin (Default: 10).").defineInRange(			"drop_chance_bee_chitin", 		10, 0, 100);
		fox_loot_chance				     = Builder.comment("Random Item chance from theiving (Default: 5).").defineInRange(		"fox_loot_chance", 				5, 0, 100);
		drop_piglin_emblem				 = Builder.comment("Drop chance for Piglin Emblems (Default: 4).").defineInRange(		"drop_piglin_emblem", 			1, 0, 100);
		drop_piglin_armbrace		 	 = Builder.comment("Drop chance for Piglin Armbrace (Default: 1).").defineInRange(		"drop_piglin_armbrace", 		1, 0, 100);
        ...
        Builder.comment("Should the following items show up on the wandering trader? Note: Some items might or might now show up automatically if you have the right cross-mod installed.");
        Builder.push("Wandering Trader show up chance");
        
	    trader_bear_black_leather	= Builder.comment("Should the trader sell black bear leather  (Default: True).").define(		"trader_bear_black_leather",	true);
        trader_bear_polar_leather	= Builder.comment("Should the trader sell polar bear leather (Default: True).").define(			"trader_bear_polar_leather",	true);
        trader_bear_panda_leather	= Builder.comment("Should the trader sell panda bear leather (Default: True).").define(			"trader_bear_panda_leather",	true);
        trader_bear_brown_leather	= Builder.comment("Should the trader sell brown bear leather  (Default: True).").define(		"trader_bear_brown_leather",	true);
        trader_vampire_fang			= Builder.comment("Should the trader sell vampire fangs  (Default: True).").define(				"trader_vampire_fang",			true);
        trader_crab_shell	 		= Builder.comment("Should the trader sell crab shells (Default: True).").define(				"trader_crab_shell",	 		true);
        trader_thrasher_tooth		= Builder.comment("Should the trader sell thrasher's teeth (Default: True).").define(			"trader_thrasher_tooth",		true);
        trader_shark_skin			= Builder.comment("Should the trader sell shark skin (Default: True).").define(					"trader_shark_skin",			true);
        trader_thrasher_skin		= Builder.comment("Should the trader sell thrasher skin (Default: True).").define(				"trader_thrasher_skin",			true);
        trader_great_threasher_skin	= Builder.comment("Should the trader sell great thrasher skin (Default: True).").define(		"trader_great_threasher_skin",	true);
        trader_fire_hound_hide		= Builder.comment("Should the trader sell fire hound hide (Default: True).").define(			"trader_fire_hound_hide",		true);
        trader_roc_feather			= Builder.comment("Should the trader sell Roc's Feather (Default: True).").define(				"trader_roc_feather",			true);
        trader_deathcap			 	= Builder.comment("Should the trader sell Deathcap Mushrooms (Default: True).").define(			"trader_deathcap",			 	true);
		trader_lightning_rod		= Builder.comment("Should the trader sell Firecharge Staff (Default: True).").define(			"trader_lightning_rod",		 	true);
        ...
        Builder.comment("The prices the wandering trader will sell stuff (in emeralds)");
        Builder.push("Wandering Trader prices");
        
	    price_bear_black_leather	= Builder.comment("The price for black bear leather  (Default: 2).").defineInRange(			"price_bear_black_leather",		2, 1, 128);
        price_bear_polar_leather	= Builder.comment("The price for polar bear leather (Default: 2).").defineInRange(			"price_bear_polar_leather",		2, 1, 128);
        price_bear_panda_leather	= Builder.comment("The price for panda bear leather (Default: 2).").defineInRange(			"price_bear_panda_leather",		2, 1, 128);
        price_bear_brown_leather	= Builder.comment("The price for brown bear leather  (Default: 2).").defineInRange(			"price_bear_brown_leather",		2, 1, 128);
		...
		price_lightning_rod			= Builder.comment("The price for Firecharge Staff (Default: 64).").defineInRange(			"price_lightning_rod",			64, 1, 128);
